...
async function scrapeRecipe(url) {
    ...
    const [el1] = await page.$x('//*[@id="__next"]/div[3]/main/div/section/div/div[3]/h1');
    const recipeName = await (await el1.getProperty('textContent')).jsonValue();

    const [el2] = await page.$x('//*[@id="__next"]/div[3]/main/div/section/div/div[3]/ul[1]/li[3]/div/div[2]');
